    ...
    >
      ...
      />
        ...
        <nav className="px-4 py-8">
          ...
          {/* Mobile Menu Footer */}
          {/* <div 
            className={`mt-12 pt-8 border-t border-gray-100 transform transition-all duration-500 ease-out ${
              isMobileMenuOpen 
                ? 'translate-y-0 opacity-100' 
                : 'translate-y-4 opacity-0'
            }`}
            style={{
              transitionDelay: isMobileMenuOpen ? `${menuItems.length * 100 + 300}ms` : '0ms'
            }}
          >
